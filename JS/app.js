...
class UI {
        ...
        products.forEach(product => {
           ...
           <div class="product">
            <div class="image-container">
                ...
                <button class="bag-btn" data-id=${product.id}>ADD<br>TO<br><i class="fas fa-shopping-cart"></i></button>
            </div>
              <h2>${product.title}</h2>
              <h4>${product.price}</h4>
            </div>
    ...
    cartLogic(){
        ...
        cartContent.addEventListener("click",event=>{
            if(event.target.classList.contains("remove-item")){
                ...
                this.removeItem(id);
                // adding the quantity of cart-item
    ...
    removeItem(id){
        ...
        button.innerHTML = `
            ADD<br>TO<br><i class="fas fa-shopping-cart"></i>
        `
    }
    getSingleButton(id){
